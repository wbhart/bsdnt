...
#define chain2_rl_1d_2s_test(fn, r, s, a, b, m, n) \
   do { \
      m = randint(100, state); \
      n = randint(100, state); \
      ...
      chain2_rl_1d_2s(fn, r, a, b, m, n); \
      fn(s, a, b, NULL); \
   } while (0)
 
#define chain3_rl_1d_2s_test(fn, r, s, a, b, m, n, p) \
   do { \
      m = randint(100, state); \
      n = randint(100, state); \
      p = randint(100, state); \
      ...
      chain3_rl_1d_2s(fn, r, a, b, m, n, p); \
      fn(s, a, b, NULL); \
   } while (0)
...
int test_add_m(void)
{
   ...
   {   
      chain2_rl_1d_2s_test(add_m, r, s, a, b, m, n);
   ...
   {      
      chain3_rl_1d_2s_test(add_m, r, s, a, b, m, n, p);
