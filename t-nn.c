...
/*
   ...
   segments of length m and n (which are randomly generated 
   by this macro).
*/
...
/*
   ...
   by this macro).
*/
#define chain2_lr_1d_2s_test(fn, r, s, a, b, m, n) \
   do { \
      m = randint(100, state); \
      n = randint(100, state); \
      new_objs(NN, &a, &b, &r, &s, NULL); \
...
/*
   ...
   to left, computes r = fn(a, b) and s = fn(a, b) where 
   r is computed by breaking a, b, r into chains with 
   segments of length m, n and p (which are randomly 
...
/*
   ...
   generated by this macro).
*/
#define chain3_lr_1d_2s_test(fn, r, s, a, b, m, n, p) \
   do { \
      m = randint(100, state); \
      n = randint(100, state); \
      p = randint(100, state); \
      ...
      randoms_of_len(m + n + p + 1, ANY, state, r, s, NULL); \
      randoms_of_len(m + n + p, ANY, state, a, b, NULL); \
      chain3_lr_1d_2s(fn, r, a, b, m, n, p); \
      fn(s, a, b, NULL); \
   } while (0)
